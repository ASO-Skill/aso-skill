---
name: aso-skill
description: Query ASO Skill for current Apple App Store search rankings, autocomplete suggestions, keyword difficulty and popularity, app metadata, credit balances, and credit-pack discovery. Use for live App Store keyword or competitor research. Do not use for Android data, download or revenue estimates, historical rankings, or predictions.
license: MIT
metadata:
  author: ASO Skill
  version: "1.8.0"
