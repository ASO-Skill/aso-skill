...
```bash
npx --yes github:aso-skill/cli#v0.1.1 status
```
...
```bash
npx --yes github:aso-skill/cli#v0.1.1 search "workout planner" --storefront US --platform iphone
npx --yes github:aso-skill/cli#v0.1.1 popularity "workout planner" --storefront US
npx --yes github:aso-skill/cli#v0.1.1 apps 123456789 987654321 --storefront US --platform iphone
npx --yes github:aso-skill/cli#v0.1.1 credits
npx --yes github:aso-skill/cli#v0.1.1 packs
```

Use `npx --yes github:aso-skill/cli#v0.1.1 help` for the complete syntax. For durable integrations, unusual response fields, authentication details, or schema questions, read [references/api.md](references/api.md) and then consult the canonical live contract at <https://www.asoskill.com/openapi.yaml>.
...
```bash
npx --yes github:aso-skill/cli#v0.1.1 checkout <pack-id> --confirm-checkout
```
